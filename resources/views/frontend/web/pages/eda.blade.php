...
<div class="row">
    <div class="col">
        <div class="card h-100">
            <img class="card-img-top" src="{{ asset('assets/img/sites/eda.jpg') }}" alt="Doctor call" height ="500 px">
            <div class="card-body">
                <h5 class="card-title">Your Doctor is one call away</h5>
                <p class="card-text">
                    Available from 6.00am to 12.00am. <br>
                    Please call this number <br> <a href="tel:+8801710101010"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
